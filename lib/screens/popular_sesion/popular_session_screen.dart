...
class PopularSessionScreen extends StatefulWidget {
  final Stream? refreshTrigger;

  PopularSessionScreen({
    Key? key,
    this.refreshTrigger,
  }) : super(key: key);

  _PopularSessionScreenState createState() => _PopularSessionScreenState();
}

class _PopularSessionScreenState extends State<PopularSessionScreen>
    with BaseStateMixin<PopularSessionStore, PopularSessionScreen> {
